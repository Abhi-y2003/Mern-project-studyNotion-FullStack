...
const Navbar = () => {
  ...
  return (
    <div className='flex h-14 items-center border border-b-richblack-700'>

        <div className='flex w-11/12 max-w-maxContent items-center justify-between mx-auto'>

             <Link to='/'>
                <img src={logo} w={120} height={32} loading='lazy'/>
             </Link>
                           ...
                           return <li key={index}>
                                {
                                    link.title === "Catalog"? (
                                        <div className='flex gap-2 items-center group relative'>
                                            ...
                                            <div className='invisible absolute   left-[50%] top-[100%] flex 
                                            translate-x-[-50%] translate-y-[50%]
                                            flex-col rounded-lg bg-richblack-5 p-4 text-richblack-900
                                            opacity-0 transition-all duration-300 group-hover:visible
                                            group-hover:opacity-100 lg:w-[300px] z-50'>
                                                
                                                <div className='absolute  h-6 w-6 left-[50%] rotate-45 
                                            rounded translate-x-[80%] bottom-[50%]
                                            bg-richblack-5'>
